...
(9, 'Star Wars:  Episode IX - The Rise of Skywalker\r\n', 1, '2019-12-20', 'PG-13', 'Science Fiction', 'The surviving members of the resistance face the First Order once again, and the legendary conflict between the Jedi and the Sith reaches its peak bringing the Skywalker saga to its end.', 1, 0, '02:21:00'),
...
CREATE TABLE IF NOT EXISTS `userhistory` (
  `userID` varchar(11) NOT NULL,
  `movieHistory` varchar(255) NOT NULL,
...
INSERT INTO `userhistory` (`userID`, `movieHistory`, `theatreAttended`) VALUES
('2018-234599', 'The Kid Detective', 'Cineplex Odeon Oshawa Cinemas'),
('2018-234599', 'Honest Theif', 'Cineplex Cinemas Pickering and VIP'),
('2018-234599', 'Shazam!', 'Cineplex Odeon Ajax Cinemas'),
('2018-378909', 'Ford v Ferrari', 'Cineplex Cinemas Pickering and VIP'),
('2018-378909', 'Tesla', 'Cineplex Cinemas Scarborough'),
('2019-100038', 'Maleficent:  Mistress of Evil', 'Cineplex Odeon Oshawa Cinemas'),
('2019-100038', 'Guardians of the Galaxy, Vol. 2', 'Cineplex Cinemas Scarborough'),
('2019-100038', 'Star Wars:  Episode IX - The rise of Skywalker', 'Cineplex Odeon Ajax Cinemas'),
('2019-100038', 'Rocketman', 'Cineplex Cinemas Markham and VIP'),
('2019-100038', 'Freaky', 'Cineplex Cinemas Scarborough'),
('2019-248890', 'Avengers:  Endgame', 'Cineplex Cinemas Pickering and VIP'),
('2019-248890', 'Vanguard (English Dub)', 'Cineplex Cinemas Pickering and VIP'),
('2019-319801', 'Joker', 'Cineplex Cinemas Markham and VIP'),
('2019-319801', 'Mulan', 'Cineplex Cinemas Markham and VIP'),
('2019-319801', 'The Call of the Wild', 'Cineplex Odeon Oshawa Cinemas'),
('2019-500200', 'The Polar Express', 'Cineplex Odeon Oshawa Cinemas'),
('2019-500200', 'The Call of the Wild', 'Cineplex Odeon Oshawa Cinemas'),
('2019-500200', '100% Wolf', 'Cineplex Odeon Ajax Cinemas'),
('2020-118882', 'Shazam!', 'Cineplex Odeon Ajax Cinemas'),
('2020-118882', 'Freaky', 'Cineplex Cinemas Scarborough'),
('2020-118882', 'Sonic the Hedgehog', 'Cineplex Odeon Oshawa Cinemas'),
('2020-118882', 'The Kid Detective', 'Cineplex Odeon Oshawa Cinemas'),
('2020-330077', 'Sonic the Hedgehog', 'Cineplex Odeon Oshawa Cinemas'),
('2020-330077', 'Rocketman', 'Cineplex Cinemas Markham and VIP'),
('2020-330077', 'The Polar Express', 'Cineplex Cinemas Markham and VIP'),
('2020-330077', 'Shazam!', 'Cineplex Odeon Ajax Cinemas'),
('2020-330077', '100% Wolf', 'Cineplex Odeon Ajax Cinemas'),
('2020-377891', 'Maleficent: Mistress of Evil', 'Cineplex Odeon Oshawa Cinemas'),
('2020-412335', 'Avengers:  Endgame', 'Cineplex Cinemas Pickering and VIP'),
('2020-412335', 'Vanguard (English Dub)', 'Cineplex Cinemas Pickering and VIP'),
('2020-881155', 'Freaky', 'Cineplex Cinemas Scarborough');
COMMIT;
